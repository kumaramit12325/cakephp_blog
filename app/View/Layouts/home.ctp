            ...
            <div class="container">
				...
				?>
                            <ul class="widget widget-menu unstyled">
                                <li class="active"><a href="<?php echo $this->html->url('/showcategorypost?category_id='.$find['Home']['category_id']); ?>"><i class="menu-icon icon-list"></i><?php echo $find['Home']['categoryname']; ?>
                                </a></li>
